...
if __name__ == '__main__':
    ...
    # dataTwoElectrons.SetTitle('')
    # dataTwoElectrons.GetXaxis().SetTitle('Invariant Mass')
    # dataTwoElectrons.GetYaxis().SetTitle('Events') 
    ...
    # dataTwoElectronsWCut.SetTitle('')
    # dataTwoElectronsWCut.GetXaxis().SetTitle('Invariant Mass')
    # dataTwoElectronsWCut.GetYaxis().SetTitle('Events') 
    ...
    def drawCICADAMessage(threshold):
        ...
        cicadaLatex.DrawLatex(0.9, 0.92, '#font[42]{2018 RunC, 13TeV} #font[52]{miniCICADA: '+f'{threshold}'+'}')
    ...
    for threshold in cicadaThresholds:
        ...
        # dataPlot.SetTitle('')
        # dataPlot.GetXaxis().SetTitle('Invariant Mass')
